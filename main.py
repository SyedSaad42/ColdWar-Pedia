...
def main():
    #setting up the frontend of the webpage
    st.set_page_config(
        layout="wide",
    ...
    if 'neo4j_connected' not in st.session_state:
        ...
        neo4j_username = st.secret['NEO4J_USERNAME']
      ...
      #  connect_button = st.sidebar.button("Connect")
        if neo4j_password:
         ...
         st.write("please provide the correct password to connect to Neo4j database.")
